...
\departmenthead{Marc Beauregard}
\programdirector{Benoit Daoust}

%\coursecode{PMO1008}
%\semester{Automne 2022}
%\courseyear{3}
%\courseurl{https://oraprdnt.uqtr.uquebec.ca/pls/public/couw001?owa_sigle=PMO1008&owa_type=P&owa_apercu=N&owa_aff_pgm=7724}
...
% Ce que le cours va offrir aux étudiants
...
% Ce que les étudiants seront capable de faire
...
Ouvrage obligatoire:
\begin{itemize}
  \item \bibentry{MarchildonQuantumMechanics2002}
\\ OU
  \item \bibentry{Cohen-TannoudjiQuantummechanics1993}
\end{itemize}

Autres références:
\begin{itemize}
  %\item \bibentry{Cohen-TannoudjiQuantummechanicsVol2005}
  \item \bibentry{SakuraiModernquantummechanics2009}
\end{itemize}
